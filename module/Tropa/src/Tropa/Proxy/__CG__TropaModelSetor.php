...
namespace Tropa\Proxy\__CG__\Tropa\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Setor extends \Tropa\Model\Setor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'codigo', 'nome', 'inputFilter');
        }

        return array('__isInitialized__', 'codigo', 'inputFilter');
    }
